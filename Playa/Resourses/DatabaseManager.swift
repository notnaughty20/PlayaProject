...
//  Playa
//
//  Created by Рафаил Фаталиев on 25.09.2021.
//
...
//        }
    ...
    public func getAllConversations(for email: String, completion: @escaping(Result<[Conversation], Error>) -> Bool) {
...
struct ChatAppUser {
    ...
    var profilePictureFileName: String {
       //rafailfataliev01-gmail-com_profile_picture.png
